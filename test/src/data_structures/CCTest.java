...
public class CCTest extends TestCase 
{
	...
	private CC<Integer, String> componentesConectados;
...
public void setupEscenario3()
{
	...
	componentesConectados= new CC<>();
}
public void testEncontarComponentes()
{
	setupEscenario1();
	setupEscenario2();
	setupEscenario3();
	assertTrue("No se encontaron todos los componentes",componentesConectados.cantidad_componentes_conectados(grafoprueba)==6);
}
